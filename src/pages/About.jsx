...
// IMPORT FOTO-FOTO EDITORIAL YCR
    ...
    <div style={{ background: '#FCFCFC', minHeight: '100vh', paddingTop: '64px' }}>
      ...
      <div className="relative py-32 px-6 overflow-hidden" style={{ background: '#0A0A0A' }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <h1 className="text-7xl md:text-[10rem] leading-none" style={{ fontFamily: 'Bebas Neue, Impact, sans-serif', color: '#FCFCFC' }}>
            About<br />YCR
          </h1>
        </div>
      </div>

      {/* Manifesto with Image Split */}
      <div className="relative py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          {/* Foto Hero Vertikal */}
          <div className="relative w-full max-w-md mx-auto md:ml-auto mt-10 md:mt-0">
      ...
      {/* Editorial Gallery (3 Photos) */}
      <div className="py-16 px-6 max-w-7xl mx-auto border-t border-[#E5E5E5]">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
          <div className="aspect-[2/3] w-full overflow-hidden mt-0 md:mt-12">
          ...
          <div className="aspect-[2/3] w-full overflow-hidden hidden md:block mt-24">
      ...
      <div className="relative py-24 px-6" style={{ background: '#F2F2F2' }}>
        <div className="max-w-7xl mx-auto">
          <h2 className="text-5xl md:text-7xl mb-16" style={{ fontFamily: 'Bebas Neue, Impact, sans-serif', color: '#0A0A0A' }}>
            Our Code
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px" style={{ border: '1px solid #DDD' }}>
            {values.map(({ label, desc }) => (
              <div key={label} className="p-10 relative group" style={{ background: '#FCFCFC', borderRight: '1px solid #DDD', borderBottom: '1px solid #DDD' }}>
